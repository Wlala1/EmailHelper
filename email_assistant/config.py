...
BOOTSTRAP_INBOX_SAMPLE_SIZE = int(os.getenv("BOOTSTRAP_INBOX_SAMPLE_SIZE", "100"))
...
SCHEDULE_AGENT_INTERVAL_SECONDS = int(os.getenv("SCHEDULE_AGENT_INTERVAL_SECONDS", "86400"))    # 24h
CATEGORY_SUGGESTION_INTERVAL_SECONDS = int(os.getenv("CATEGORY_SUGGESTION_INTERVAL_SECONDS", "604800"))  # 1 week
